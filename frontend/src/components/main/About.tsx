        ...
        <div className="about-boxes">
          <div className="about-txt-box">
            ...
            <strong className="about-des-box">
              ...
              بازی خود را موقعی که میخواهید بازی ایجاد کنید عمومی انتخاب کنید
          ...
          <div className="about-txt-box">
            ...
            <strong className="about-des-box">
              ...
              بازی انتخاب کرده بود تصادفی انتخاب میشه) یک شماره معکوس میشوماریم
              و بازیکن ها سوال را میخوانند. بعد که شماره معکوس تمام شد یک لیست
              برای انتخاب مهره ها نمایش داده میشه. آن مهره ها شامل (1 امتیازی و
              2 و 3 امتیازی هستند) اگر کاربر 3 امتیازی انتخاب کند بدون هیج
          ...
          <div className="about-txt-box">
            ...
            <strong className="about-des-box">
              ...
              بازیه خودش شرط ببندد. دو تا دکمه در اختیار شما است . در یک سمت
              دکمه + و در سمت دیگر دکمه - است خب مثبت یعنی اینکه شما رو جواب
              دادن درست آن کاربر به سوال نمایش شده شرط میبندید برای مثال 2 سکه
              شرط میبندید که آن کاربر جواب درست را میدهد و اما میتوانید بر جواب
          ...
          <div className="about-txt-box">
            ...
            <strong className="about-des-box">
              ...
              اگر اشتباه جواب داده باشد به آن میزان به سکه هات اضافه میشه. (توجه
              درست جواب دادن هم امتیاز دارد یعنی اگر شما مهره 3 امتیازی انتخاب
              کرده باشید اگر به سوال درست جواب داده باشید 3 سکه به شما اضافه
              میشود و اگر 2 انتخاب کرده باشی 2 امتیاز و اگر 1 یک امتیاز ولی اگر
              اشتباه جواب بدید هیچی نه کم میشه نه زیاد!)
            </strong>
          </div>
          <div className="about-txt-box">
            <img
            ...
            <strong className="about-des-box">
              ...
              چرخه تا زمانی ادامه پیدا میکنه که یک بازیکن به حداکثر امتیاز سکه
              دست بیابد و بقیه بازیکن ها بازنده حساب میشوند! پس موقع شرط بندی
              دقت کن! (حداکثر سکه رو سازنده بازی تئین میکند) موفق باشی :)
            </strong>
          </div>
        </div>
      </div>
